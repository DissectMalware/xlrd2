...
func_defs = {
    ...
    0x0051: ('ARGUMENT', 0,	3,	0x00,	3, 'V', 'VAR'),
    ...
    0x8000: ('BEEP', 1, 1, 0x00, 1, 'V', 'V'),
    0x8001: ('OPEN', 0, 17, 0x00, 17, 'V', 'VVVVVVVVVVVVVVVVV'),
    0x8002: ('OPEN.LINKS', 0, 15, 0x00, 15, 'V', 'VVVVVVVVVVVVVVV'),
    0x8003: ('CLOSE.ALL', 0, 0, 0x00, 0, 'V', ''),
    0x8004: ('SAVE', 0, 0, 0x00, 0, 'V', ''),
    0x8005: ('SAVE.AS', 0, 7, 0x00, 7, 'V', 'VVVVVVV'),
    0x8006: ('FILE.DELETE', 1, 1, 0x00, 1, 'V', 'V'),
    0x8007: ('PAGE.SETUP', 0, 30, 0x00, 30, 'V', 'VVVVVVVVVVVVVVVVVVVVVVVVVVVVVV'),
    0x8008: ('PRINT', 0, 17, 0x00, 17, 'V', 'VVVVVVVVVVVVVVVVV'),
    0x8009: ('PRINTER.SETUP', 1, 1, 0x00, 1, 'V', 'V'),
    0x800A: ('QUIT', 0, 0, 0x00, 0, 'V', ''),
    0x800B: ('NEW.WINDOW', 0, 0, 0x00, 0, 'V', ''),
    0x800C: ('ARRANGE.ALL', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x800D: ('WINDOW.SIZE', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x800E: ('WINDOW.MOVE', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x800F: ('FULL', 1, 1, 0x00, 1, 'V', 'V'),
    0x8010: ('CLOSE', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8011: ('RUN', 0, 2, 0x00, 2, 'V', 'AV'),
    0x8016: ('SET.PRINT.AREA', 1, 1, 0x00, 1, 'V', 'A'),
    0x8017: ('SET.PRINT.TITLES', 0, 2, 0x00, 2, 'V', 'AA'),
    0x8018: ('SET.PAGE.BREAK', 0, 0, 0x00, 0, 'V', ''),
    0x8019: ('REMOVE.PAGE.BREAK', 0, 2, 0x00, 2, 'V', 'VV'),
    0x801A: ('FONT', 0, 2, 0x00, 2, 'V', 'VV'),
    0x801B: ('DISPLAY', 0, 9, 0x00, 9, 'V', 'VVVVVVVVV'),
    0x801C: ('PROTECT.DOCUMENT', 0, 7, 0x00, 7, 'V', 'VVVVVVV'),
    0x801D: ('PRECISION', 1, 1, 0x00, 1, 'V', 'V'),
    0x801E: ('A1.R1C1', 1, 1, 0x00, 1, 'V', 'V'),
    0x801F: ('CALCULATE.NOW', 0, 0, 0x00, 0, 'V', ''),
    0x8020: ('CALCULATION', 0, 11, 0x00, 11, 'V', 'VVVVVVVVVVV'),
    0x8022: ('DATA.FIND', 1, 1, 0x00, 1, 'V', 'V'),
    0x8023: ('EXTRACT', 1, 1, 0x00, 1, 'V', 'V'),
    0x8024: ('DATA.DELETE', 0, 0, 0x00, 0, 'V', ''),
    0x8025: ('SET.DATABASE', 0, 0, 0x00, 0, 'V', ''),
    0x8026: ('SET.CRITERIA', 0, 0, 0x00, 0, 'V', ''),
    0x8027: ('SORT', 0, 17, 0x00, 17, 'V', 'VAAAAAAVVVVVVVVVV'),
    0x8028: ('DATA.SERIES', 0, 6, 0x00, 6, 'V', 'VVVVVV'),
    0x8029: ('TABLE', 0, 2, 0x00, 2, 'V', 'AA'),
    0x802A: ('FORMAT.NUMBER', 1, 1, 0x00, 1, 'V', 'V'),
    0x802B: ('ALIGNMENT', 0, 10, 0x00, 10, 'V', 'VVVVVVVVVV'),
    0x802C: ('STYLE', 0, 2, 0x00, 2, 'V', 'VV'),
    0x802D: ('BORDER', 0, 27, 0x00, 27, 'V', 'VVVVVVVVVVVVVVVVVVVVVVVVVVV'),
    0x802E: ('CELL.PROTECTION', 0, 2, 0x00, 2, 'V', 'VV'),
    0x802F: ('COLUMN.WIDTH', 0, 5, 0x00, 5, 'V', 'VAAAA'),
    0x8030: ('UNDO', 0, 0, 0x00, 0, 'V', ''),
    0x8031: ('CUT', 0, 2, 0x00, 2, 'V', 'AA'),
    0x8032: ('COPY', 0, 2, 0x00, 2, 'V', 'AA'),
    0x8033: ('PASTE', 1, 1, 0x00, 1, 'V', 'A'),
    0x8034: ('CLEAR', 1, 1, 0x00, 1, 'V', 'V'),
    0x8035: ('PASTE.SPECIAL', 0, 7, 0x00, 7, 'V', 'VVVVVVV'),
    0x8036: ('EDIT.DELETE', 1, 1, 0x00, 1, 'V', 'V'),
    0x8037: ('INSERT', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8038: ('FILL.RIGHT', 0, 0, 0x00, 0, 'V', ''),
    0x8039: ('FILL.DOWN', 0, 0, 0x00, 0, 'V', ''),
    0x803D: ('DEFINE.NAME', 0, 7, 0x00, 7, 'V', 'VAAAAAV'),
    0x803E: ('CREATE.NAMES', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x803F: ('FORMULA.GOTO', 0, 2, 0x00, 2, 'V', 'AV'),
    0x8040: ('FORMULA.FIND', 0, 12, 0x00, 12, 'V', 'VVVVVVVVVVVV'),
    0x8041: ('SELECT.LAST.CELL', 0, 0, 0x00, 0, 'V', ''),
    0x8042: ('SHOW.ACTIVE.CELL', 0, 0, 0x00, 0, 'V', ''),
    0x8043: ('GALLERY.AREA', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8044: ('GALLERY.BAR', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8045: ('GALLERY.COLUMN', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8046: ('GALLERY.LINE', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8047: ('GALLERY.PIE', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8048: ('GALLERY.SCATTER', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8049: ('COMBINATION', 1, 1, 0x00, 1, 'V', 'V'),
    0x804A: ('PREFERRED', 0, 0, 0x00, 0, 'V', ''),
    0x804B: ('ADD.OVERLAY', 0, 0, 0x00, 0, 'V', ''),
    0x804C: ('GRIDLINES', 0, 7, 0x00, 7, 'V', 'VVVVVVV'),
    0x804D: ('SET.PREFERRED', 1, 1, 0x00, 1, 'V', 'V'),
    0x804E: ('AXES', 0, 6, 0x00, 6, 'V', 'VVVVVV'),
    0x804F: ('LEGEND', 1, 1, 0x00, 1, 'V', 'V'),
    0x8050: ('ATTACH.TEXT', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x8051: ('ADD.ARROW', 0, 0, 0x00, 0, 'V', ''),
    0x8052: ('SELECT.CHART', 0, 0, 0x00, 0, 'V', ''),
    0x8053: ('SELECT.PLOT.AREA', 0, 0, 0x00, 0, 'V', ''),
    0x8054: ('PATTERNS', 0, 13, 0x00, 13, 'V', 'VVVVVVVVVVVVV'),
    0x8055: ('MAIN.CHART', 0, 10, 0x00, 10, 'V', 'VVVVVVVVVV'),
    0x8056: ('OVERLAY', 0, 12, 0x00, 12, 'V', 'VVVVVVVVVVVV'),
    0x8057: ('SCALE', 0, 10, 0x00, 10, 'V', 'VVVVVVVVVV'),
    0x8058: ('FORMAT.LEGEND', 1, 1, 0x00, 1, 'V', 'V'),
    0x8059: ('FORMAT.TEXT', 0, 11, 0x00, 11, 'V', 'VVVVVVVVVVV'),
    0x805A: ('EDIT.REPEAT', 0, 0, 0x00, 0, 'V', ''),
    0x805B: ('PARSE', 0, 2, 0x00, 2, 'V', 'VA'),
    0x805C: ('JUSTIFY', 0, 0, 0x00, 0, 'V', ''),
    0x805D: ('HIDE', 0, 0, 0x00, 0, 'V', ''),
    0x805E: ('UNHIDE', 1, 1, 0x00, 1, 'V', 'V'),
    0x805F: ('WORKSPACE', 0, 16, 0x00, 16, 'V', 'VVVVVVVVVVVVVVVV'),
    0x8060: ('FORMULA', 0, 2, 0x00, 2, 'V', 'VA'),
    0x8061: ('FORMULA.FILL', 0, 2, 0x00, 2, 'V', 'VA'),
    0x8062: ('FORMULA.ARRAY', 0, 2, 0x00, 2, 'V', 'VA'),
    ...
    0x8067: ('ACTIVATE', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8068: ('ACTIVATE.NEXT', 1, 1, 0x00, 1, 'V', 'V'),
    0x8069: ('ACTIVATE.PREV', 1, 1, 0x00, 1, 'V', 'V'),
    0x806A: ('UNLOCKED.NEXT', 0, 0, 0x00, 0, 'V', ''),
    0x806B: ('UNLOCKED.PREV', 0, 0, 0x00, 0, 'V', ''),
    0x806C: ('COPY.PICTURE', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x806D: ('SELECT', 0, 2, 0x00, 2, 'V', 'AA'),
    0x806E: ('DELETE.NAME', 1, 1, 0x00, 1, 'V', 'V'),
    0x806F: ('DELETE.FORMAT', 1, 1, 0x00, 1, 'V', 'V'),
    0x8070: ('VLINE', 1, 1, 0x00, 1, 'V', 'V'),
    0x8071: ('HLINE', 1, 1, 0x00, 1, 'V', 'V'),
    0x8072: ('VPAGE', 1, 1, 0x00, 1, 'V', 'V'),
    0x8073: ('HPAGE', 1, 1, 0x00, 1, 'V', 'V'),
    0x8074: ('VSCROLL', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8075: ('HSCROLL', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8076: ('ALERT', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x8077: ('NEW', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x8078: ('CANCEL.COPY', 1, 1, 0x00, 1, 'V', 'V'),
    0x8079: ('SHOW.CLIPBOARD', 0, 0, 0x00, 0, 'V', ''),
    0x807A: ('MESSAGE', 0, 2, 0x00, 2, 'V', 'VV'),
    0x807C: ('PASTE.LINK', 0, 0, 0x00, 0, 'V', ''),
    0x807D: ('APP.ACTIVATE', 0, 2, 0x00, 2, 'V', 'VV'),
    0x807E: ('DELETE.ARROW', 0, 0, 0x00, 0, 'V', ''),
    0x807F: ('ROW.HEIGHT', 0, 4, 0x00, 4, 'V', 'VAAA'),
    0x8080: ('FORMAT.MOVE', 0, 3, 0x00, 3, 'V', 'VAA'),
    0x8081: ('FORMAT.SIZE', 0, 3, 0x00, 3, 'V', 'VAA'),
    0x8082: ('FORMULA.REPLACE', 0, 11, 0x00, 11, 'V', 'VVVVVVVVVVV'),
    0x8083: ('SEND.KEYS', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8084: ('SELECT.SPECIAL', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x8085: ('APPLY.NAMES', 0, 7, 0x00, 7, 'V', 'VVVVVVV'),
    0x8086: ('REPLACE.FONT', 0, 10, 0x00, 10, 'V', 'VVVVVVVVVV'),
    0x8087: ('FREEZE.PANES', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x8088: ('SHOW.INFO', 1, 1, 0x00, 1, 'V', 'V'),
    0x8089: ('SPLIT', 0, 2, 0x00, 2, 'V', 'VV'),
    0x808A: ('ON.WINDOW', 0, 2, 0x00, 2, 'V', 'VV'),
    0x808B: ('ON.DATA', 0, 2, 0x00, 2, 'V', 'VV'),
    0x808C: ('DISABLE.INPUT', 1, 1, 0x00, 1, 'V', 'V'),
    0x808E: ('OUTLINE', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x808F: ('LIST.NAMES', 0, 0, 0x00, 0, 'V', ''),
    0x8090: ('FILE.CLOSE', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8091: ('SAVE.WORKBOOK', 0, 6, 0x00, 6, 'V', 'VVVVVV'),
    0x8092: ('DATA.FORM', 0, 0, 0x00, 0, 'V', ''),
    0x8093: ('COPY.CHART', 1, 1, 0x00, 1, 'V', 'V'),
    0x8094: ('ON.TIME', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x8095: ('WAIT', 1, 1, 0x00, 1, 'V', 'V'),
    0x8096: ('FORMAT.FONT', 0, 15, 0x00, 15, 'V', 'VVVVVVVVVVVVVVV'),
    0x8097: ('FILL.UP', 0, 0, 0x00, 0, 'V', ''),
    0x8098: ('FILL.LEFT', 0, 0, 0x00, 0, 'V', ''),
    0x8099: ('DELETE.OVERLAY', 0, 0, 0x00, 0, 'V', ''),
    0x809B: ('SHORT.MENUS', 1, 1, 0x00, 1, 'V', 'V'),
    0x809F: ('SET.UPDATE.STATUS', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x80A1: ('COLOR.PALETTE', 1, 1, 0x00, 1, 'V', 'V'),
    0x80A2: ('DELETE.STYLE', 1, 1, 0x00, 1, 'V', 'V'),
    0x80A3: ('WINDOW.RESTORE', 1, 1, 0x00, 1, 'V', 'V'),
    0x80A4: ('WINDOW.MAXIMIZE', 1, 1, 0x00, 1, 'V', 'V'),
    0x80A6: ('CHANGE.LINK', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x80A7: ('CALCULATE.DOCUMENT', 0, 0, 0x00, 0, 'V', ''),
    0x80A8: ('ON.KEY', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80A9: ('APP.RESTORE', 0, 0, 0x00, 0, 'V', ''),
    0x80AA: ('APP.MOVE', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80AB: ('APP.SIZE', 0, 2, 0x00, 2, 'V', 'VV'),
    ...
    0x80B9: ('MAIN.CHART.TYPE', 1, 1, 0x00, 1, 'V', 'V'),
    0x80BA: ('OVERLAY.CHART.TYPE', 1, 1, 0x00, 1, 'V', 'V'),
    0x80BB: ('SELECT.END', 1, 1, 0x00, 1, 'V', 'V'),
    0x80BC: ('OPEN.MAIL', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80BD: ('SEND.MAIL', 0, 3, 0x00, 3, 'V', 'AVV'),
    0x80BE: ('STANDARD.FONT', 0, 9, 0x00, 9, 'V', 'VVVVVVVVV'),
    0x80BF: ('CONSOLIDATE', 0, 5, 0x00, 5, 'V', 'VVVVV'),
    0x80C0: ('SORT.SPECIAL', 0, 14, 0x00, 14, 'V', 'VVAAAAAAVVVVVV'),
    0x80C1: ('GALLERY.3D.AREA', 1, 1, 0x00, 1, 'V', 'V'),
    0x80C2: ('GALLERY.3D.COLUMN', 1, 1, 0x00, 1, 'V', 'V'),
    0x80C3: ('GALLERY.3D.LINE', 1, 1, 0x00, 1, 'V', 'V'),
    0x80C4: ('GALLERY.3D.PIE', 1, 1, 0x00, 1, 'V', 'V'),
    0x80C5: ('VIEW.3D', 0, 6, 0x00, 6, 'V', 'VVVVVV'),
    0x80C6: ('GOAL.SEEK', 0, 3, 0x00, 3, 'V', 'AAA'),
    0x80C7: ('WORKGROUP', 1, 1, 0x00, 1, 'V', 'V'),
    0x80C8: ('FILL.GROUP', 1, 1, 0x00, 1, 'V', 'V'),
    0x80C9: ('UPDATE.LINK', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80CA: ('PROMOTE', 1, 1, 0x00, 1, 'V', 'V'),
    0x80CB: ('DEMOTE', 1, 1, 0x00, 1, 'V', 'V'),
    0x80CC: ('SHOW.DETAIL', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x80CE: ('UNGROUP', 0, 0, 0x00, 0, 'V', ''),
    0x80CF: ('OBJECT.PROPERTIES', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80D0: ('SAVE.NEW.OBJECT', 1, 1, 0x00, 1, 'V', 'V'),
    0x80D1: ('SHARE', 0, 0, 0x00, 0, 'V', ''),
    0x80D2: ('SHARE.NAME', 1, 1, 0x00, 1, 'V', 'V'),
    0x80D3: ('DUPLICATE', 0, 0, 0x00, 0, 'V', ''),
    0x80D4: ('APPLY.STYLE', 1, 1, 0x00, 1, 'V', 'V'),
    0x80D5: ('ASSIGN.TO.OBJECT', 1, 1, 0x00, 1, 'V', 'A'),
    0x80D6: ('OBJECT.PROTECTION', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80D7: ('HIDE.OBJECT', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80D8: ('SET.EXTRACT', 0, 0, 0x00, 0, 'V', ''),
    0x80D9: ('CREATE.PUBLISHER', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x80DA: ('SUBSCRIBE.TO', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80DB: ('ATTRIBUTES', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80DC: ('SHOW.TOOLBAR', 0, 10, 0x00, 10, 'V', 'VVVVVVVVVV'),
    0x80DE: ('PRINT.PREVIEW', 1, 1, 0x00, 1, 'V', 'V'),
    0x80DF: ('EDIT.COLOR', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x80E0: ('SHOW.LEVELS', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80E1: ('FORMAT.MAIN', 0, 14, 0x00, 14, 'V', 'VVVVVVVVVVVVVV'),
    0x80E2: ('FORMAT.OVERLAY', 0, 14, 0x00, 14, 'V', 'VVVVVVVVVVVVVV'),
    0x80E3: ('ON.RECALC', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80E4: ('EDIT.SERIES', 0, 7, 0x00, 7, 'V', 'VAAAAAA'),
    0x80E5: ('DEFINE.STYLE', 0, 14, 0x00, 14, 'V', 'VVVVVVVVVVVVVV'),
    0x80F0: ('LINE.PRINT', 0, 11, 0x00, 11, 'V', 'VVVVVVVVVVV'),
    0x80F3: ('ENTER.DATA', 1, 1, 0x00, 1, 'V', 'A'),
    0x80F9: ('GALLERY.RADAR', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80FA: ('MERGE.STYLES', 1, 1, 0x00, 1, 'V', 'V'),
    0x80FB: ('EDITION.OPTIONS', 0, 7, 0x00, 7, 'V', 'VAAAAAA'),
    0x80FC: ('PASTE.PICTURE', 0, 0, 0x00, 0, 'V', ''),
    0x80FD: ('PASTE.PICTURE.LINK', 0, 0, 0x00, 0, 'V', ''),
    0x80FE: ('SPELLING', 0, 6, 0x00, 6, 'V', 'VVVVVV'),
    0x8100: ('ZOOM', 1, 1, 0x00, 1, 'V', 'V'),
    0x8103: ('INSERT.OBJECT', 0, 13, 0x00, 13, 'V', 'VVVVVVVAVVAVV'),
    0x8104: ('WINDOW.MINIMIZE', 1, 1, 0x00, 1, 'V', 'V'),
    0x8109: ('SOUND.NOTE', 0, 3, 0x00, 3, 'V', 'AVV'),
    0x810A: ('SOUND.PLAY', 0, 3, 0x00, 3, 'V', 'AVV'),
    0x810B: ('FORMAT.SHAPE', 0, 5, 0x00, 5, 'V', 'VVAVV'),
    0x810C: ('EXTEND.POLYGON', 1, 1, 0x00, 1, 'V', 'V'),
    0x810D: ('FORMAT.AUTO', 0, 7, 0x00, 7, 'V', 'VVVVVVV'),
    0x8110: ('GALLERY.3D.BAR', 1, 1, 0x00, 1, 'V', 'V'),
    0x8111: ('GALLERY.3D.SURFACE', 1, 1, 0x00, 1, 'V', 'V'),
    0x8112: ('FILL.AUTO', 0, 2, 0x00, 2, 'V', 'AV'),
    0x8114: ('CUSTOMIZE.TOOLBAR', 1, 1, 0x00, 1, 'V', 'V'),
    0x8115: ('ADD.TOOL', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x8116: ('EDIT.OBJECT', 1, 1, 0x00, 1, 'V', 'V'),
    0x8117: ('ON.DOUBLECLICK', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8118: ('ON.ENTRY', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8119: ('WORKBOOK.ADD', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x811A: ('WORKBOOK.MOVE', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x811B: ('WORKBOOK.COPY', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x811C: ('WORKBOOK.OPTIONS', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x811D: ('SAVE.WORKSPACE', 1, 1, 0x00, 1, 'V', 'V'),
    0x8120: ('CHART.WIZARD', 0, 14, 0x00, 14, 'V', 'VAVVVVVVVVVVVV'),
    0x8121: ('DELETE.TOOL', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8122: ('MOVE.TOOL', 0, 6, 0x00, 6, 'V', 'VVVVVV'),
    0x8123: ('WORKBOOK.SELECT', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x8124: ('WORKBOOK.ACTIVATE', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8125: ('ASSIGN.TO.TOOL', 0, 3, 0x00, 3, 'V', 'VVA'),
    0x8127: ('COPY.TOOL', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8128: ('RESET.TOOL', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8129: ('CONSTRAIN.NUMERIC', 1, 1, 0x00, 1, 'V', 'V'),
    0x812A: ('PASTE.TOOL', 0, 2, 0x00, 2, 'V', 'VV'),
    0x812E: ('WORKBOOK.NEW', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x8131: ('SCENARIO.CELLS', 1, 1, 0x00, 1, 'V', 'A'),
    0x8132: ('SCENARIO.DELETE', 1, 1, 0x00, 1, 'V', 'V'),
    0x8133: ('SCENARIO.ADD', 0, 6, 0x00, 6, 'V', 'VVAVVV'),
    0x8134: ('SCENARIO.EDIT', 0, 7, 0x00, 7, 'V', 'VVVAVVV'),
    0x8135: ('SCENARIO.SHOW', 1, 1, 0x00, 1, 'V', 'V'),
    0x8136: ('SCENARIO.SHOW.NEXT', 0, 0, 0x00, 0, 'V', ''),
    0x8137: ('SCENARIO.SUMMARY', 0, 2, 0x00, 2, 'V', 'AV'),
    0x8138: ('PIVOT.TABLE.WIZARD', 0, 16, 0x00, 16, 'V', 'VAAVVVVVVVVVVVVV'),
    0x8139: ('PIVOT.FIELD.PROPERTIES', 0, 7, 0x00, 7, 'V', 'VVVVVVV'),
    0x813A: ('PIVOT.FIELD', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x813B: ('PIVOT.ITEM', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x813C: ('PIVOT.ADD.FIELDS', 0, 5, 0x00, 5, 'V', 'VVVVV'),
    0x813E: ('OPTIONS.CALCULATION', 0, 10, 0x00, 10, 'V', 'VVVVVVVVVV'),
    0x813F: ('OPTIONS.EDIT', 0, 11, 0x00, 11, 'V', 'VVVVVVVVVVV'),
    0x8140: ('OPTIONS.VIEW', 0, 18, 0x00, 18, 'V', 'VVVVVVVVVVVVVVVVVV'),
    0x8141: ('ADDIN.MANAGER', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x8142: ('MENU.EDITOR', 0, 0, 0x00, 0, 'V', ''),
    0x8143: ('ATTACH.TOOLBARS', 0, 0, 0x00, 0, 'V', ''),
    0x8144: ('VBAActivate', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8145: ('OPTIONS.CHART', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x8148: ('VBA.INSERT.FILE', 1, 1, 0x00, 1, 'V', 'V'),
    0x814A: ('VBA.PROCEDURE.DEFINITION', 0, 0, 0x00, 0, 'V', ''),
    0x8150: ('ROUTING.SLIP', 0, 6, 0x00, 6, 'V', 'AVVVVV'),
    0x8152: ('ROUTE.DOCUMENT', 0, 0, 0x00, 0, 'V', ''),
    0x8153: ('MAIL.LOGON', 0, 3, 0x00, 3, 'V', 'AAV'),
    0x8156: ('INSERT.PICTURE', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8157: ('EDIT.TOOL', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8158: ('GALLERY.DOUGHNUT', 0, 2, 0x00, 2, 'V', 'VV'),
    0x815E: ('CHART.TREND', 0, 8, 0x00, 8, 'V', 'VVVVVVVV'),
    0x8160: ('PIVOT.ITEM.PROPERTIES', 0, 7, 0x00, 7, 'V', 'VVVVVVV'),
    0x8162: ('WORKBOOK.INSERT', 1, 1, 0x00, 1, 'V', 'V'),
    0x8163: ('OPTIONS.TRANSITION', 0, 5, 0x00, 5, 'V', 'VVVVV'),
    0x8164: ('OPTIONS.GENERAL', 0, 14, 0x00, 14, 'V', 'VVVVVVVVVVVVVV'),
    0x8172: ('FILTER.ADVANCED', 0, 5, 0x00, 5, 'V', 'VAAAV'),
    ...
    0x817B: ('DATA.LABEL', 0, 10, 0x00, 10, 'V', 'VVVVVVVVVV'),
    0x817C: ('INSERT.TITLE', 0, 5, 0x00, 5, 'V', 'VVVVV'),
    0x817D: ('FONT.PROPERTIES', 0, 14, 0x00, 14, 'V', 'VVVVVVVVVVVVVV'),
    0x817E: ('MACRO.OPTIONS', 0, 10, 0x00, 10, 'V', 'VVVVVVVVVV'),
    0x817F: ('WORKBOOK.HIDE', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8180: ('WORKBOOK.UNHIDE', 1, 1, 0x00, 1, 'V', 'V'),
    0x8181: ('WORKBOOK.DELETE', 1, 1, 0x00, 1, 'V', 'V'),
    0x8182: ('WORKBOOK.NAME', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8184: ('GALLERY.CUSTOM', 1, 1, 0x00, 1, 'V', 'V'),
    0x8186: ('ADD.CHART.AUTOFORMAT', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8187: ('DELETE.CHART.AUTOFORMAT', 1, 1, 0x00, 1, 'V', 'V'),
    0x8188: ('CHART.ADD.DATA', 0, 6, 0x00, 6, 'V', 'VAVVVV'),
    0x8189: ('AUTO.OUTLINE', 0, 0, 0x00, 0, 'V', ''),
    0x818A: ('TAB.ORDER', 0, 0, 0x00, 0, 'V', ''),
    0x818B: ('SHOW.DIALOG', 1, 1, 0x00, 1, 'V', 'V'),
    0x818C: ('SELECT.ALL', 0, 0, 0x00, 0, 'V', ''),
    0x818D: ('UNGROUP.SHEETS', 0, 0, 0x00, 0, 'V', ''),
    0x818E: ('SUBTOTAL.CREATE', 0, 6, 0x00, 6, 'V', 'VVVVVV'),
    0x818F: ('SUBTOTAL.REMOVE', 0, 0, 0x00, 0, 'V', ''),
    0x8190: ('RENAME.OBJECT', 1, 1, 0x00, 1, 'V', 'V'),
    0x819C: ('WORKBOOK.SCROLL', 0, 2, 0x00, 2, 'V', 'VV'),
    0x819D: ('WORKBOOK.NEXT', 0, 0, 0x00, 0, 'V', ''),
    0x819E: ('WORKBOOK.PREV', 0, 0, 0x00, 0, 'V', ''),
    0x819F: ('WORKBOOK.TAB.SPLIT', 1, 1, 0x00, 1, 'V', 'V'),
    0x81A0: ('FULL.SCREEN', 1, 1, 0x00, 1, 'V', 'V'),
    0x81A1: ('WORKBOOK.PROTECT', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x81A4: ('SCROLLBAR.PROPERTIES', 0, 7, 0x00, 7, 'V', 'VVVVVVV'),
    0x81A5: ('PIVOT.SHOW.PAGES', 0, 2, 0x00, 2, 'V', 'VV'),
    0x81A6: ('TEXT.TO.COLUMNS', 0, 14, 0x00, 14, 'V', 'VAVVVVVVVVVVVV'),
    0x81A7: ('FORMAT.CHARTTYPE', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x81A8: ('LINK.FORMAT', 0, 0, 0x00, 0, 'V', ''),
    0x81A9: ('TRACER.DISPLAY', 0, 2, 0x00, 2, 'V', 'VV'),
    0x81AE: ('TRACER.NAVIGATE', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x81AF: ('TRACER.CLEAR', 0, 0, 0x00, 0, 'V', ''),
    0x81B0: ('TRACER.ERROR', 0, 0, 0x00, 0, 'V', ''),
    0x81B1: ('PIVOT.FIELD.GROUP', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x81B2: ('PIVOT.FIELD.UNGROUP', 0, 0, 0x00, 0, 'V', ''),
    0x81B3: ('CHECKBOX.PROPERTIES', 0, 5, 0x00, 5, 'V', 'VVVVV'),
    0x81B4: ('LABEL.PROPERTIES', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x81B5: ('LISTBOX.PROPERTIES', 0, 5, 0x00, 5, 'V', 'VVVVV'),
    0x81B6: ('EDITBOX.PROPERTIES', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x81B7: ('PIVOT.REFRESH', 1, 1, 0x00, 1, 'V', 'V'),
    0x81B8: ('LINK.COMBO', 1, 1, 0x00, 1, 'V', 'V'),
    0x81B9: ('OPEN.TEXT', 0, 17, 0x00, 17, 'V', 'VVVVVVVVVVVVVVVVV'),
    0x81BA: ('HIDE.DIALOG', 1, 1, 0x00, 1, 'V', 'V'),
    0x81BB: ('SET.DIALOG.FOCUS', 1, 1, 0x00, 1, 'V', 'V'),
    0x81BC: ('ENABLE.OBJECT', 0, 2, 0x00, 2, 'V', 'VV'),
    0x81BD: ('PUSHBUTTON.PROPERTIES', 0, 6, 0x00, 6, 'V', 'VVVVVV'),
    0x81BE: ('SET.DIALOG.DEFAULT', 1, 1, 0x00, 1, 'V', 'V'),
    0x81BF: ('FILTER', 0, 6, 0x00, 6, 'V', 'VVVVVV'),
    0x81C0: ('FILTER.SHOW.ALL', 0, 0, 0x00, 0, 'V', ''),
    0x81C1: ('CLEAR.OUTLINE', 0, 0, 0x00, 0, 'V', ''),
    0x81C2: ('FUNCTION.WIZARD', 1, 1, 0x00, 1, 'V', 'V'),
    0x81C3: ('ADD.LIST.ITEM', 0, 2, 0x00, 2, 'V', 'VV'),
    0x81C4: ('SET.LIST.ITEM', 0, 2, 0x00, 2, 'V', 'VV'),
    0x81C5: ('REMOVE.LIST.ITEM', 0, 2, 0x00, 2, 'V', 'VV'),
    0x81C6: ('SELECT.LIST.ITEM', 0, 2, 0x00, 2, 'V', 'VV'),
    0x81C7: ('SET.CONTROL.VALUE', 1, 1, 0x00, 1, 'V', 'V'),
    0x81C8: ('SAVE.COPY.AS', 1, 1, 0x00, 1, 'V', 'V'),
    0x81CA: ('OPTIONS.LISTS.ADD', 0, 2, 0x00, 2, 'V', 'VA'),
    0x81CB: ('OPTIONS.LISTS.DELETE', 1, 1, 0x00, 1, 'V', 'V'),
    0x81CC: ('SERIES.AXES', 1, 1, 0x00, 1, 'V', 'V'),
    0x81CD: ('SERIES.X', 1, 1, 0x00, 1, 'V', 'A'),
    0x81CE: ('SERIES.Y', 0, 2, 0x00, 2, 'V', 'AA'),
    0x81CF: ('ERRORBAR.X', 0, 4, 0x00, 4, 'V', 'VVVA'),
    0x81D0: ('ERRORBAR.Y', 0, 4, 0x00, 4, 'V', 'VVVA'),
    0x81D1: ('FORMAT.CHART', 0, 18, 0x00, 18, 'V', 'AVVVVVVVVVVVVVVVVV'),
    0x81D2: ('SERIES.ORDER', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x81D3: ('MAIL.LOGOFF', 0, 0, 0x00, 0, 'V', ''),
    0x81D4: ('CLEAR.ROUTING.SLIP', 1, 1, 0x00, 1, 'V', 'V'),
    0x81D5: ('APP.ACTIVATE.MICROSOFT', 1, 1, 0x00, 1, 'V', 'V'),
    0x81D6: ('MAIL.EDIT.MAILER', 0, 6, 0x00, 6, 'V', 'VAAAVA'),
    0x81D7: ('ON.SHEET', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x81D8: ('STANDARD.WIDTH', 1, 1, 0x00, 1, 'V', 'V'),
    0x81D9: ('SCENARIO.MERGE', 1, 1, 0x00, 1, 'V', 'V'),
    0x81DA: ('SUMMARY.INFO', 0, 5, 0x00, 5, 'V', 'VVVVV'),
    0x81DB: ('FIND.FILE', 0, 0, 0x00, 0, 'V', ''),
    0x81DC: ('ACTIVE.CELL.FONT', 0, 14, 0x00, 14, 'V', 'VVVVVVVVVVVVVV'),
    0x81DD: ('ENABLE.TIPWIZARD', 1, 1, 0x00, 1, 'V', 'V'),
    0x81DE: ('VBA.MAKE.ADDIN', 1, 1, 0x00, 1, 'V', 'V'),
    0x81E0: ('INSERTDATATABLE', 1, 1, 0x00, 1, 'V', 'V'),
    0x81E1: ('WORKGROUP.OPTIONS', 0, 0, 0x00, 0, 'V', ''),
    0x81E2: ('MAIL.SEND.MAILER', 0, 2, 0x00, 2, 'V', 'VV'),
    0x81E5: ('AUTOCORRECT', 0, 2, 0x00, 2, 'V', 'VV'),
    0x81E9: ('POST.DOCUMENT', 1, 1, 0x00, 1, 'V', 'V'),
    0x81EB: ('PICKLIST', 0, 0, 0x00, 0, 'V', ''),
    0x81ED: ('VIEW.SHOW', 1, 1, 0x00, 1, 'V', 'V'),
    0x81EE: ('VIEW.DEFINE', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x81EF: ('VIEW.DELETE', 1, 1, 0x00, 1, 'V', 'V'),
    0x81FD: ('SHEET.BACKGROUND', 0, 2, 0x00, 2, 'V', 'VV'),
    0x81FE: ('INSERT.MAP.OBJECT', 0, 0, 0x00, 0, 'V', ''),
    0x81FF: ('OPTIONS.MENONO', 0, 5, 0x00, 5, 'V', 'VVVVV'),
    0x8205: ('MSOCHECKS', 0, 0, 0x00, 0, 'V', ''),
    0x8206: ('NORMAL', 0, 0, 0x00, 0, 'V', ''),
    0x8207: ('LAYOUT', 0, 0, 0x00, 0, 'V', ''),
    0x8208: ('RM.PRINT.AREA', 1, 1, 0x00, 1, 'V', 'A'),
    0x8209: ('CLEAR.PRINT.AREA', 0, 0, 0x00, 0, 'V', ''),
    0x820A: ('ADD.PRINT.AREA', 0, 0, 0x00, 0, 'V', ''),
    0x820B: ('MOVE.BRK', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x8221: ('HIDECURR.NOTE', 0, 2, 0x00, 2, 'V', 'AV'),
    0x8222: ('HIDEALL.NOTES', 1, 1, 0x00, 1, 'V', 'V'),
    0x8223: ('DELETE.NOTE', 1, 1, 0x00, 1, 'V', 'A'),
    0x8224: ('TRAVERSE.NOTES', 0, 2, 0x00, 2, 'V', 'AV'),
    0x8225: ('ACTIVATE.NOTES', 0, 2, 0x00, 2, 'V', 'AV'),
    0x826C: ('PROTECT.REVISIONS', 0, 0, 0x00, 0, 'V', ''),
    0x826D: ('UNPROTECT.REVISIONS', 0, 0, 0x00, 0, 'V', ''),
    0x8287: ('OPTIONS.ME', 0, 9, 0x00, 9, 'V', 'AVVVVVVVV'),
    0x828D: ('WEB.PUBLISH', 0, 9, 0x00, 9, 'V', 'VVVVVVVVV'),
    0x829B: ('NEWWEBQUERY', 1, 1, 0x00, 1, 'V', 'V'),
    0x82A1: ('PIVOT.TABLE.CHART', 0, 16, 0x00, 16, 'V', 'VAAVVVVVVVVVVVVV'),
    0x82F1: ('OPTIONS.SAVE', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x82F3: ('OPTIONS.SPELL', 0, 12, 0x00, 12, 'V', 'VVVVVVVVVVVV'),
    0x8328: ('HIDEALL.INKANNOTS', 1, 1, 0x00, 1, 'V', 'V'),
}
