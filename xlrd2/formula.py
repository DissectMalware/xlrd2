...
func_defs = {
    ...
    0x005D: ('DOCUMENTS', 0,	1,	0x04,	0, 'V', 'V'),
    ...
    0x800F: ('FULL', 0, 1, 0x00, 1, 'V', 'V'),
    0x8010: ('CLOSE', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8011: ('RUN', 0, 2, 0x00, 2, 'V', 'AV'),
    0x8016: ('SET.PRINT.AREA', 0, 1, 0x00, 1, 'V', 'A'),
    ...
    0x801D: ('PRECISION', 0, 1, 0x00, 1, 'V', 'V'),
    0x801E: ('A1.R1C1', 0, 1, 0x00, 1, 'V', 'V'),
    0x801F: ('CALCULATE.NOW', 0, 0, 0x00, 0, 'V', ''),
    0x8020: ('CALCULATION', 0, 11, 0x00, 11, 'V', 'VVVVVVVVVVV'),
    0x8022: ('DATA.FIND', 0, 1, 0x00, 1, 'V', 'V'),
    0x8023: ('EXTRACT', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x802A: ('FORMAT.NUMBER', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x8033: ('PASTE', 0, 1, 0x00, 1, 'V', 'A'),
    0x8034: ('CLEAR', 0, 1, 0x00, 1, 'V', 'V'),
    0x8035: ('PASTE.SPECIAL', 0, 7, 0x00, 7, 'V', 'VVVVVVV'),
    0x8036: ('EDIT.DELETE', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x8058: ('FORMAT.LEGEND', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x8068: ('ACTIVATE.NEXT', 0, 1, 0x00, 1, 'V', 'V'),
    0x8069: ('ACTIVATE.PREV', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x806E: ('DELETE.NAME', 0, 1, 0x00, 1, 'V', 'V'),
    0x806F: ('DELETE.FORMAT', 0, 1, 0x00, 1, 'V', 'V'),
    0x8070: ('VLINE', 0, 1, 0x00, 1, 'V', 'V'),
    0x8071: ('HLINE', 0, 1, 0x00, 1, 'V', 'V'),
    0x8072: ('VPAGE', 0, 1, 0x00, 1, 'V', 'V'),
    0x8073: ('HPAGE', 0, 1, 0x00, 1, 'V', 'V'),
    0x8074: ('VSCROLL', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8075: ('HSCROLL', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8076: ('ALERT', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x8077: ('NEW', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x8078: ('CANCEL.COPY', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x8093: ('COPY.CHART', 0, 1, 0x00, 1, 'V', 'V'),
    0x8094: ('ON.TIME', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x8095: ('WAIT', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x809B: ('SHORT.MENUS', 0, 1, 0x00, 1, 'V', 'V'),
    0x809F: ('SET.UPDATE.STATUS', 0, 3, 0x00, 3, 'V', 'VVV'),
    0x80A1: ('COLOR.PALETTE', 0, 1, 0x00, 1, 'V', 'V'),
    0x80A2: ('DELETE.STYLE', 0, 1, 0x00, 1, 'V', 'V'),
    0x80A3: ('WINDOW.RESTORE', 0, 1, 0x00, 1, 'V', 'V'),
    0x80A4: ('WINDOW.MAXIMIZE', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x80B9: ('MAIN.CHART.TYPE', 0, 1, 0x00, 1, 'V', 'V'),
    0x80BA: ('OVERLAY.CHART.TYPE', 0, 1, 0x00, 1, 'V', 'V'),
    0x80BB: ('SELECT.END', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x80C1: ('GALLERY.3D.AREA', 0, 1, 0x00, 1, 'V', 'V'),
    0x80C2: ('GALLERY.3D.COLUMN', 0, 1, 0x00, 1, 'V', 'V'),
    0x80C3: ('GALLERY.3D.LINE', 0, 1, 0x00, 1, 'V', 'V'),
    0x80C4: ('GALLERY.3D.PIE', 0, 1, 0x00, 1, 'V', 'V'),
    0x80C5: ('VIEW.3D', 0, 6, 0x00, 6, 'V', 'VVVVVV'),
    0x80C6: ('GOAL.SEEK', 0, 3, 0x00, 3, 'V', 'AAA'),
    0x80C7: ('WORKGROUP', 0, 1, 0x00, 1, 'V', 'V'),
    0x80C8: ('FILL.GROUP', 0, 1, 0x00, 1, 'V', 'V'),
    0x80C9: ('UPDATE.LINK', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80CA: ('PROMOTE', 0, 1, 0x00, 1, 'V', 'V'),
    0x80CB: ('DEMOTE', 0, 1, 0x00, 1, 'V', 'V'),
    0x80CC: ('SHOW.DETAIL', 0, 4, 0x00, 4, 'V', 'VVVV'),
    0x80CE: ('UNGROUP', 0, 0, 0x00, 0, 'V', ''),
    0x80CF: ('OBJECT.PROPERTIES', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80D0: ('SAVE.NEW.OBJECT', 0, 1, 0x00, 1, 'V', 'V'),
    0x80D1: ('SHARE', 0, 0, 0x00, 0, 'V', ''),
    0x80D2: ('SHARE.NAME', 0, 1, 0x00, 1, 'V', 'V'),
    0x80D3: ('DUPLICATE', 0, 0, 0x00, 0, 'V', ''),
    0x80D4: ('APPLY.STYLE', 0, 1, 0x00, 1, 'V', 'V'),
    0x80D5: ('ASSIGN.TO.OBJECT', 0, 1, 0x00, 1, 'V', 'A'),
    ...
    0x80DE: ('PRINT.PREVIEW', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x80F3: ('ENTER.DATA', 0, 1, 0x00, 1, 'V', 'A'),
    0x80F9: ('GALLERY.RADAR', 0, 2, 0x00, 2, 'V', 'VV'),
    0x80FA: ('MERGE.STYLES', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x811D: ('SAVE.WORKSPACE', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x8148: ('VBA.INSERT.FILE', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x8162: ('WORKBOOK.INSERT', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x8180: ('WORKBOOK.UNHIDE', 0, 1, 0x00, 1, 'V', 'V'),
    0x8181: ('WORKBOOK.DELETE', 0, 1, 0x00, 1, 'V', 'V'),
    0x8182: ('WORKBOOK.NAME', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8184: ('GALLERY.CUSTOM', 0, 1, 0x00, 1, 'V', 'V'),
    0x8186: ('ADD.CHART.AUTOFORMAT', 0, 2, 0x00, 2, 'V', 'VV'),
    0x8187: ('DELETE.CHART.AUTOFORMAT', 0, 1, 0x00, 1, 'V', 'V'),
    0x8188: ('CHART.ADD.DATA', 0, 6, 0x00, 6, 'V', 'VAVVVV'),
    0x8189: ('AUTO.OUTLINE', 0, 0, 0x00, 0, 'V', ''),
    0x818A: ('TAB.ORDER', 0, 0, 0x00, 0, 'V', ''),
    0x818B: ('SHOW.DIALOG', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x8190: ('RENAME.OBJECT', 0, 1, 0x00, 1, 'V', 'V'),
    0x819C: ('WORKBOOK.SCROLL', 0, 2, 0x00, 2, 'V', 'VV'),
    0x819D: ('WORKBOOK.NEXT', 0, 0, 0x00, 0, 'V', ''),
    0x819E: ('WORKBOOK.PREV', 0, 0, 0x00, 0, 'V', ''),
    0x819F: ('WORKBOOK.TAB.SPLIT', 0, 1, 0x00, 1, 'V', 'V'),
    0x81A0: ('FULL.SCREEN', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x81C7: ('SET.CONTROL.VALUE', 0, 1, 0x00, 1, 'V', 'V'),
    0x81C8: ('SAVE.COPY.AS', 0, 1, 0x00, 1, 'V', 'V'),
    0x81CA: ('OPTIONS.LISTS.ADD', 0, 2, 0x00, 2, 'V', 'VA'),
    0x81CB: ('OPTIONS.LISTS.DELETE', 0, 1, 0x00, 1, 'V', 'V'),
    0x81CC: ('SERIES.AXES', 0, 1, 0x00, 1, 'V', 'V'),
    0x81CD: ('SERIES.X', 0, 1, 0x00, 1, 'V', 'A'),
    ...
    0x8208: ('RM.PRINT.AREA', 0, 1, 0x00, 1, 'V', 'A'),
    ...
    0x8222: ('HIDEALL.NOTES', 0, 1, 0x00, 1, 'V', 'V'),
    0x8223: ('DELETE.NOTE', 0, 1, 0x00, 1, 'V', 'A'),
    ...
    0x829B: ('NEWWEBQUERY', 0, 1, 0x00, 1, 'V', 'V'),
    ...
    0x8328: ('HIDEALL.INKANNOTS', 0, 1, 0x00, 1, 'V', 'V'),
}
