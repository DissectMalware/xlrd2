...
class TestXlsxParse(unittest.TestCase):
    ...
    def test_for_github_issue_96(self):
        ...
        workbook = xlrd2.open_workbook(from_this_dir('apachepoi_49609.xlsx'))
        worksheet = workbook.sheet_by_index(0)
        ...
        self.assertEqual(cell.ctype, xlrd2.book.XL_CELL_NUMBER)
    ...
    def test_for_github_issue_101(self):
        ...
        workbook = xlrd2.open_workbook(from_this_dir('self_evaluation_report_2014-05-19.xlsx'))
        worksheet = workbook.sheet_by_index(0)
    ...
    def test_for_github_issue_150(self):
        ...
        workbook = xlrd2.open_workbook(from_this_dir('issue150.xlsx'))
        worksheet = workbook.sheet_by_index(0)
